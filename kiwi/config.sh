...
mkdir -p /etc/YaST2/
mv /studio/overlay-tmp/files//etc/YaST2//firstboot-standard.xml /etc/YaST2//firstboot-suse-cloud.xml
...
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.iso /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.iso
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.iso
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.iso
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.md5 /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.md5
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.md5
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.md5
mkdir -p /srv/tftpboot/txz/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5 /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
mkdir -p /srv/tftpboot/iso/
mkdir -p /etc/init.d/
