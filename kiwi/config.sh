...
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.iso /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GM-DVD1.iso
...
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GMC-DVD1.md5 /srv/tftpboot/iso//SUSE-CLOUD-4-x86_64-GM-DVD1.md5
