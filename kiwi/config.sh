...
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.iso /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.iso
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.iso
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.iso
mkdir -p /srv/tftpboot/iso/
mv /studio/overlay-tmp/files//srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.md5 /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.md5
chown root:root /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.md5
chmod 644 /srv/tftpboot/iso//SUSE-CLOUD-3-x86_64-GM-DVD1.md5
