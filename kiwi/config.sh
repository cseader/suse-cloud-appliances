...
mv /studio/overlay-tmp/files//srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
chown root:root /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
chmod 644 /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.iso
mkdir -p /srv/tftpboot/txz/
mv /studio/overlay-tmp/files//srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5 /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
chown root:root /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
chmod 644 /srv/tftpboot/txz//SUSE-CLOUD-4-DEPS-x86_64-GMC-DVD.md5
mkdir -p /srv/tftpboot/txz/
mkdir -p /etc/init.d/
